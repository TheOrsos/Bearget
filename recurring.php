...
<body class="text-gray-200">
            ...
            <header class="flex flex-wrap justify-between items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-white flex items-center gap-3">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h5m11 2a9 9 0 11-2.93-6.93"></path></svg>
    ...
    <div id="recurring-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden">
        ...
        <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-2xl p-6 transform scale-95 opacity-0 modal-content">
            <h2 id="recurring-modal-title" class="text-2xl font-bold text-white mb-6">Nuova Transazione Ricorrente</h2>
